...
import (
	...
	experimentTypes "github.com/litmuschaos/litmus-go/pkg/generic/pod-network-corruption/types"
...
func GetContainerArguments(experimentsDetails *experimentTypes.ExperimentDetails, appName string) []string {
	args := []string{
		...
		"corrupt",
		"--percent", strconv.Itoa(experimentsDetails.NetworkPacketCorruptionPercentage),
		"re2:k8s_POD_" + appName + "_" + experimentsDetails.AppNS,
	}
