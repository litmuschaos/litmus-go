...
//PrepareEC2StopByTag contains the prepration and injection steps for the experiment
func PrepareEC2StopByTag(experimentsDetails *experimentTypes.ExperimentDetails, clients clients.ClientSets, resultDetails *types.ResultDetails, eventsDetails *types.EventDetails, chaosDetails *types.ChaosDetails) error {
