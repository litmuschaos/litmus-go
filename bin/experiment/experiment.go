...
import (
	...
	virtualDiskLoss "github.com/litmuschaos/litmus-go/experiments/azure/virtual-disk-loss/experiment"
...
func main() {
	...
	case "virtual-disk-loss":
		virtualDiskLoss.VirtualDiskLoss(clients)
