...
import (
	...
	azureInstanceTerminate "github.com/litmuschaos/litmus-go/experiments/azure/instance-terminate/experiment"
...
func main() {
	...
	case "azure-instance-terminate":
		azureInstanceTerminate.InstanceTerminate(clients)
	default:
