...
import (
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/ec2-cpu-stress/lib"
	clients "github.com/litmuschaos/litmus-go/pkg/clients"
	"github.com/litmuschaos/litmus-go/pkg/cloud/aws"
	"github.com/litmuschaos/litmus-go/pkg/events"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/kube-aws/ec2-cpu-stress/environment"
...
// Ec2CPUStress inject the ebs volume loss chaos
func Ec2CPUStress(clients clients.ClientSets) {
	...
	case "litmus":
		if err = litmusLIB.PrepareEC2StressChaos(&experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
