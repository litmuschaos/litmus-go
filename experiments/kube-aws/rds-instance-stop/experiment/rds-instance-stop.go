...
func RDSInstanceStop(clients clients.ClientSets) {
	...
	if chaosDetails.DefaultHealthCheck {
		...
		log.Info("[Status]: RDS instance is in available state")
	}

	chaosDetails.Phase = types.ChaosInjectPhase

	if err = litmusLIB.PrepareRDSInstanceStop(&experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
