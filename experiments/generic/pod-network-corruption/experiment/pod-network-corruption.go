...
func PodNetworkCorruption(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PodNetworkCorruptionChaos(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
