...
func PodHttpResetPeer(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PodHttpResetPeerChaos(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
