...
func PodHttpModifyHeader(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PodHttpModifyHeaderChaos(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
