...
func PodHttpStatusCode(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PodHttpStatusCodeChaos(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
