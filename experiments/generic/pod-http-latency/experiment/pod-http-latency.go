...
func PodHttpLatency(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of pod-http-latency experiment (SOT), err: " + err.Error()
	...
	case experimentsDetails.ChaosLib == "litmus":
		if err := litmusLIB.K8sHttpLatencyChaos(&experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
