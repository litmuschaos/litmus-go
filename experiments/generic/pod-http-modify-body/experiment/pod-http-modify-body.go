...
func PodHttpModifyBody(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PodHttpModifyBodyChaos(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
