...
func PodNetworkLatency(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PodNetworkLatencyChaos(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
