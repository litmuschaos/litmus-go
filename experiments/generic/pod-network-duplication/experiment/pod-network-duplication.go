...
func PodNetworkDuplication(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PodNetworkDuplicationChaos(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
