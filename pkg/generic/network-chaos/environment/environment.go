...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	...
	experimentDetails.ChaosInterval = common.Getenv("CHAOS_INTERVAL", "")
	experimentDetails.NetworkFaultWindow, _ = strconv.Atoi(common.Getenv("NETWORK_FAULT_WINDOW", "60"))
	experimentDetails.ChaosDuration, _ = strconv.Atoi(common.Getenv("TOTAL_CHAOS_DURATION", strconv.Itoa(experimentDetails.NetworkFaultWindow)))
