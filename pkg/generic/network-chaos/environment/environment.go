...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails, expName string) {
	...
	experimentDetails.AppNS = types.Getenv("APP_NAMESPACE", "shubham")
	experimentDetails.AppLabel = types.Getenv("APP_LABEL", "app=deploy1")
	experimentDetails.AppKind = types.Getenv("APP_KIND", "deployment")
	...
	experimentDetails.PodsAffectedPerc = types.Getenv("PODS_AFFECTED_PERC", "100")
	experimentDetails.NodeLabel = types.Getenv("NODE_LABEL", "")
	experimentDetails.DestinationIPs = types.Getenv("DESTINATION_IPS", "8.8.8.8")
	experimentDetails.DestinationHosts = types.Getenv("DESTINATION_HOSTS", "google.com")
	experimentDetails.ContainerRuntime = types.Getenv("CONTAINER_RUNTIME", "docker")
	experimentDetails.ChaosServiceAccount = types.Getenv("CHAOS_SERVICE_ACCOUNT", "litmus")
